          ...
          <form className="space-y-4 lg:w-[720px] " onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <select className="w-[65px] lg:w-20 px-2 py-2  border-[#121212] focus:outline-none focus:ring-1 focus:ring-[#121212] bg-transparent font-['Space_Mono'] dark:border-white  text-[#817F7F] dark:placeholder:text-[#585858] lg:h-[60px] border-[0.9px]">
                ...
                <input
                  ...
                  className="flex-1 px-4 py-2 border-[#121212] dark:border-white   focus:outline-none focus:ring-1 focus:ring-[#121212] bg-transparent font-['Space_Mono'] placeholder:font-['Space_Mono'] placeholder:text-[#817F7F] dark:placeholder:text-[#585858] border-[0.9px] lg:h-[60px] lg:text-[19.89px]"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <textarea
                  ...
                  className="w-full px-4 py-2 border border-[#121212] dark:border-white focus:outline-none focus:ring-1 focus:ring-[#121212] bg-transparent font-['Space_Mono'] placeholder:font-['Space_Mono'] placeholder:text-[#817F7F] dark:placeholder:text-[#585858] resize-none border-[0.9px] lg:h-[157px] lg:pt-4 lg:mb-[4px] lg:text-[19.89px]"
                ></textarea>
              </div>
            </div>
